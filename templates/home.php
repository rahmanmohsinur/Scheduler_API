    ...
    <script>
        ...
        */
        ...
        async function getTasks() {
            try {
                const taskData = await fetch("http://localhost/scheduler_API/api/");
        ...
        async function toggleComplete(task) {
            try {
                ...
                const taskComplete = await fetch("http://localhost/scheduler_API/api/", {method:"POST", body:params});
                getTasks();
            }
            catch (error) {
        ...
        async function removeTask(task) {
            try {
                ...
                const taskData = await fetch("http://localhost/scheduler_API/api/", {method:"POST", body:params});
                getTasks();
            }
            catch (error) {
        ...
        function viewTask(task) {
            window.location.href = `?route=view_task&taskID=${task.taskID}`;
            //window.location.href = `view_task?taskID=${task.taskID}`; // Redirect to new page with taskID in URL
